...
/**
  ...
  Parameter i_conditions samnles
    ...
    case 2 (Sorting):
      { "_ORDER_BY": [ "col2_name", {"col3_name":"asc"} ] }
      => ORDER BY col2_name, col3_name ASC
    case 3 (Limit):
      { "_LIMIT_BY": 10 } => LIMIT 10
      { "_LIMIT_BY": [0, 10] } => LIMIT 0, 10
    case 4 (Paging):
      { "_PAGE_BY": [1, 10] } => LIMIT 0, 10
      (*) Process '_LIMIT_BY' only if '_LIMIT_BY' and '_PAGE_BY' are present at the same conditions
